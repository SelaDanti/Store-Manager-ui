let productUrl = `https://storemanage3000.herokuapp.com/api/v2/products`;
let cartUrl = `https://storemanage3000.herokuapp.com/api/v2/cart`;
let saleUrl = `https://storemanage3000.herokuapp.com/api/v2/sales`;
let productHead = `
<table>
			<tr>
...
function addCart()
{
	...
	let payload = {"product name": id,"quantity": quantity}
	fetch(cartUrl,{
		"method": "POST",
		"mod": "cors",
		headers: {
